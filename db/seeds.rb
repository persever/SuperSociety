...
Group.create(name: "I Have Powers Because Science", description: "Seems legit, right?", creator: User.find_by({ username: "Spiderman"}), photo_url: "http://res.cloudinary.com/dgzqgdlmj/image/upload/v1434235810/mutant_ucqzsi.jpgname")
...
Event.create(group: Group.find_by({ name: "Asgardians"}), title: "Revels", datetime: "2015-06-09 08:00:00+00", location: "Asgard", description: "We will regale each other with stories of our glorious triumphs.")
...
Event.create(group: Group.find_by({ name: "Gamers"}), title: "Game Night", datetime: "2015-06-13 19:00:00+00", location: "Stark's Hosue", description: "Lego Marvel")
Event.create(group: Group.find_by({ name: "Gamers"}), title: "Game Night", datetime: "2015-07-18 19:00:00+00", location: "Stark's Hosue", description: "Ultimate Alliance")
Event.create(group: Group.find_by({ name: "Gamers"}), title: "Game Night", datetime: "2015-08-15 19:00:00+00", location: "Stark's Hosue", description: "Mario Kart")
Event.create(group: Group.find_by({ name: "Gamers"}), title: "Game Night", datetime: "2015-09-19 19:00:00+00", location: "Stark's Hosue", description: "Mortal Kombat vs. DC Universe")
...
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-06-13 19:00:00+00" }), user: User.find_by({ username: "Deadpool" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-06-13 19:00:00+00" }), user: User.find_by({ username: "Iron Man" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-06-13 19:00:00+00" }), user: User.find_by({ username: "Batgirl" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-06-13 19:00:00+00" }), user: User.find_by({ username: "Hawkeye" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-06-13 19:00:00+00" }), user: User.find_by({ username: "Spiderman" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-06-13 19:00:00+00" }), user: User.find_by({ username: "Womder Woman" }))

Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-07-18 19:00:00+00" }), user: User.find_by({ username: "Deadpool" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-07-18 19:00:00+00" }), user: User.find_by({ username: "Captain America" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-07-18 19:00:00+00" }), user: User.find_by({ username: "Spiderman" }))

Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "Deadpool" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "Iron Man" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "Batman" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "The Flash" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "Supergirl" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "Hawkeye" }))
Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-08-15 19:00:00+00" }), user: User.find_by({ username: "Black Widow" }))

Attending.create(event: Event.find_by({ title: "Game Night", datetime: "2015-09-19 19:00:00+00" }), user: User.find_by({ username: "Deadpool" }))
