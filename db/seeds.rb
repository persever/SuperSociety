...
Group.create(name: "Gamers", description: "Because fictional fights can take the edge off the real ones. (And it's fun to play your teammates.)", creator: User.find_by({ username: "Deadpool"}), photo_url: "http://res.cloudinary.com/dgzqgdlmj/image/upload/v1434228251/gamers_vjvzj9.jpg")
